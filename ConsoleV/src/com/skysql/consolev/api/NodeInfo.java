...
public class NodeInfo {
	...
	public String ToolTip() {
	    ...
	    return "<h2>" + (this.nodeID.equalsIgnoreCase("0") ? "System" : "Node") + "</h2>"+
	              "<ul>"+
	              "<li><b>ID:</b> " + this.nodeID + "</li>"+
	              "<li><b>Name:</b> " + this.name + "</li>"+
	              (this.nodeID.equalsIgnoreCase("0") ? "" : "<li><b>Public IP:</b> " + this.publicIP + "</li>")+
	              (this.nodeID.equalsIgnoreCase("0") ? "" : "<li><b>Private IP:</b> " + this.privateIP + "</li>")+
	              (this.nodeID.equalsIgnoreCase("0") ? "" : "<li><b>Instance ID:</b> " + this.instanceID + "</li>")+
	              "<li><b>Status:</b> " + ((this.status == null) ? "n/a" : NodeStates.getNodeStatesDescriptions().get(this.status)) + "</li>"+
	              "<li><b>Availabilty:</b> " + ((this.health == null) ? "n/a" : this.health) + "%</li>"+
	              "<li><b>Connections:</b> " + ((this.connections == null) ? "n/a" : this.connections) + "</li>"+
	              "<li><b>Data Transfer:</b> " + ((this.packets == null) ? "n/a" : this.packets) + " KB</li>"+
	              "<li><b>Available Commands:</b> " + ((this.commands == null) ? "n/a" : commands) + "</li>"+
	              "<li><b>Task ID:</b> " + ((this.task == null) ? "n/a" : this.task) + "</li>"+
