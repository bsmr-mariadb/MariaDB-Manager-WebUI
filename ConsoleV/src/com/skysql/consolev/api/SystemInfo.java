...
public class SystemInfo {
	...
	public String ToolTip() {
	    ...
	    return 	  "<li><b>Nodes:</b> " + ((this.nodes == null) ? "n/a" : Arrays.toString(this.nodes)) + "</li>"+
	    		  "<li><b>Start Date:</b> " + ((this.startDate == null) ? "n/a" : this.startDate) + "</li>"+
	              "<li><b>Last Stop:</b> " + ((this.lastStop == null) ? "n/a" : this.lastStop) + "</li>"+
	              "<li><b>Last Access:</b> " + ((this.lastAccess == null) ? "n/a" : this.lastAccess) + "</li>"+
	              "<li><b>Last Backup:</b> " + ((this.lastBackup == null) ? "n/a" : this.lastBackup) + "</li>"+
	              "</ul>";		
	}
